...
const Contact = () => {
  return (
    <Container>
      <div
        className="flex flex-col gap-5 py-5 text-white md:px-16 px-2"
        id="contact"
      >
        ...
        <footer className="border-t pt-5 flex md:flex-row flex-col-reverse gap-2 justify-between items-center">
          <div>
            <p className="">&copy; 2024 - Ye Pyae Aung, All rights reserved</p>
          </div>
          <div className="flex items-center gap-5">
            ...
            <a href="viber://chat?number=09898626060" target="_blank">
              <svg
                className="size-6"
                fill="white"
                xmlns="http://www.w3.org/2000/svg"
